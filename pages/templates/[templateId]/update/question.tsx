...
const TemplateQuestionUpdatePage: React.FC = () => {
    ...
    return (
        <PageWrapper language={template?.data?.primary_language}>
            <SEO title={strings.templatesSections.question.update.title} />
            <PageHeader
                ...
                title={strings.templatesSections.question.update.title}
            />
            ...
            <Form.Container
                ...
                initialValues={pick(template?.data, Object.keys(questionSchema.fields))}
                name="template-question-update-form"
                options={{
                    primary_language: () => {
            ...
            >
                <FormSection
                    ...
                    text={strings.templatesSections.question.details.text}
                    title={strings.templatesSections.question.details.title}
                >
                    <Form.Fields />
                    <Form.Errors />
                </FormSection>
